...
2023.12.13 : README.md에 시각화 이미지 파일 추가 및 수정 작업을 했다.
</pre>
-------------------------------------------------------------------------------------------------------------------------------
## 3. 분석 과정
...
![덱별 대전 통계  최근 7일, 플래티넘, 아시아 서버](https://github.com/tlthr764/codingon_project_03/assets/143565463/5debbc8f-5838-40f0-86e3-04e1c84b60c3)

### Solution
- 성기사는 직업 중에 2번째로 큰 점유율을 차지한다.
- 어그로 성기사와 결투 성기사 (Showdown Paladin) 덱들은 50%가 넘는 평균 승률을 보이고 매치업 상성도 양호하다.
